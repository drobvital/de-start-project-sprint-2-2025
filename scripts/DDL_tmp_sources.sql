...
SELECT  t2.order_id,
  ...
  FROM source2.craft_market_masters_products t1 
   INNER JOIN source2.craft_market_orders_customers t2 ON t2.product_id = t1.product_id and t1.craftsman_id = t2.craftsman_id 
UNION
SELECT  t1.order_id,
...
inner join external_source.customers c on cpo.customer_id=c.customer_id;
