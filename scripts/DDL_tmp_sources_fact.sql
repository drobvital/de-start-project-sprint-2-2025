...
join dwh.d_customer dcs on dcs.customer_name=src.customer_name and dcs.customer_email=src.customer_email
join dwh.d_product dp on dp.product_name = src.product_name and dp.product_description=src.product_description and 
